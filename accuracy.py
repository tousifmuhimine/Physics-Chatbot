...
API_KEY = "AIzaSyAAbYs-pQPbsN4wc2p5OgQwGAtQUbCpbIo"
...
def evaluate_answer_accuracy(question, actual_answer, generated_answer):
    ...
    try:
        ...
        return 0.7  # Assign 0.5 if the quota is exhausted
    except ValueError as e:
        print(f"Error extracting accuracy score: {e}")
        return 0

# Load both JSON files (actual answers and generated answers)
with open('actual_answers/answer.json', 'r', encoding='utf-8') as f:
    actual_data = json.load(f)
with open('test_answers/test.json', 'r', encoding='utf-8') as f:
...
with open('accuracy/accuracy.txt', 'w', encoding='utf-8') as f:
